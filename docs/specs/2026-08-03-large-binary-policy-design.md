...
**PRD refs:** `docs/prd/vaults-sync.md` §Edge cases ("Large binaries in an adopted repo"); `docs/prd/_phase2-pdf-docx-preview.md` §"Where originals live" (the deferred vault-size question that survives D62); `docs/decisions.md` D62.
