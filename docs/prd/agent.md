...
**Holi app settings.**
- **`.holi/settings/app.json`** — vault-wide app settings, committed.
- **`.holi/settings/app.local.json`** — machine-local, gitignored (sync watermarks, reminder delivery state, UI prefs).
