...
**Goals**
- The live-preview *feel*: rendered markdown inline; putting the caret on an **element** reveals that element's raw source for editing; leaving it re-renders. **Instant swap, no animation.**
