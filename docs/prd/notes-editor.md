...
**Not persisted.** Whether tabs survive a restart is still open; `.holi/settings/app.local.json` is where the answer would go. Deliberately unanswered rather than guessed at.
