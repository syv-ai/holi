...
export const editorTheme = EditorView.baseTheme({
   ...
   *
   * One exception, and it is kept out of this base on purpose: a note alone in
   * the window, with no split, centres (#13, `index.css` §Solo note column),
   * because then nothing can open beside it without the user asking for a new
   * layout.
   */
